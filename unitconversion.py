...
def main():
    ...
    while True:
        ...
        console.print("3. Celsius to Fahrenheit")
        console.print("4. Fahrenheit to Celsius")
        console.print("5. Kilograms to Pounds")
        console.print("6. Pounds to Kilograms")
        console.print("7. Liters to Gallons")
        console.print("8. Gallons to Liters")
        console.print("9. View Conversion History")
        console.print("0. Exit")

        choice = input("Choose conversion (0-9): ").strip()
        ...
        if choice == "1":
            ...
            console.print(f"{value} km = {result:.2f} miles", style="cyan")
